                ...
                <table>
                    ...
                    <tbody>
                        {products.map((product, index) => {
                            const imageSrc = product?.images?.[0] || "/placeholder.jpg"; // safe fallback
                            return (
                                <tr key={index}>
                                    <td>
                                        <img
                                    ...
                                    <td className="p-[10px]">{product?.productId || "N/A"}</td>
                                    <td className="p-[10px]">{product?.name || "Unnamed"}</td>
                                    <td className="p-[10px]">{product?.price ?? "N/A"}</td>
                                    <td className="p-[10px]">{product?.labelledPrice ?? "N/A"}</td>
                                    <td className="p-[10px]">{product?.category || "N/A"}</td>
                                    <td className="p-[10px]">{product?.stock ?? "N/A"}</td>
